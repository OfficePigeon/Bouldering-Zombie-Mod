...
public class BoulderingZombieEntityModel extends ZombieEntityModel<BoulderingZombieEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(34, 32).cuboid(-1, -2, -2, 5, 14, 4), ModelTransform.pivot(5, 2, 0));
		modelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(16, 32).cuboid(-4, -2, -2, 5, 14, 4), ModelTransform.pivot(-5, 2, 0));
		modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 34).cuboid(-1.9f, 0, -2, 4, 12, 4), ModelTransform.pivot(1.9f, 12, 0));
